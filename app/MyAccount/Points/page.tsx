        ...
        {products.map((product) => (
          <div key={product.id} className="ticket-card">
            <div className="ticket-content">
              <div className="ticket-points text-customDarkBlue">{product.points} Points</div>
              <div className="ticket-info">
                <button
                  onClick={() => handleExchange(product.points)}
                  className="bg-white text-customDarkGreen px-4 py-2 rounded"
            ...
            <div className="ticket-image">
              ...
              <div className="absolute bottom-0 left-0 p-4 text-customDarkBlue">
